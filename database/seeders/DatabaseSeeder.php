...
//        $roles = ['mesero', 'cocina', 'rrhh', 'admin'];
        ...
        Producto::factory()->create([
            ...
            'activo' => true,
            'id_categoria' => 4,
            'foto' => 'helado_caramelosalado.png'
        ]);
